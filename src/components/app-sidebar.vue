...
<style>
  ...
  .app-sidebar .menu-item .item-text {
    padding-left: 10px;
  }

  .app-sidebar .menu-item .el-icon-caret-right {
    position: absolute;
    right: 15px;
    top: 20px;
  }

  .app-sidebar .sub-menu > .menu-item .el-icon-caret-right {
    position: absolute;
    right: 15px;
    top: 15px;
  }
  ...
  .app-sidebar .menu-item:hover > .sub-menu {
    display: block;
    border-top-right-radius: 3px;
    border-bottom-right-radius: 3px;
  }

  .app-sidebar .menu-item > .sub-menu {
    display: none;
    position: absolute;
    width: 180px;
    right: -180px;
  ...
  .app-sidebar .sub-menu > .menu-item {
    height: 40px;
    line-height: 40px;
  }
  ...
  .app-sidebar .menu.thin {
  }

  .app-sidebar .menu.thin .menu-first-item > .item-text {
    display: none;
  }

  .app-sidebar .menu.thin .menu-first-item:hover > .item-text {
    position: absolute;
    bottom: -12px;
    left: 5px;
    z-index: 2;
  ...
  .app-sidebar .menu.thin .menu-first-item > .el-icon-caret-right {
    display: none;
  }
</style>
